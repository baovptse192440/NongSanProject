...
export default function OrderDetailPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#eeeeee] md:mt-20 mt-16">
  ...
  if (!order) {
    return (
      <div className="min-h-screen bg-[#eeeeee] md:mt-20 ">
        <div className="mx-auto w-full max-w-7xl pl-[0.4rem] pr-[0.4rem] md:pl-4 md:pr-4 py-20">
      ...
      <div className="hidden md:flex overflow-x-auto bg-[#e6e6e6] border-gray-200">
        <div className="mx-auto w-full max-w-7xl pl-[0.4rem] pr-[0.4rem] md:pl-4 md:pr-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/agency/profile" className="hover:text-green-600">Profile</Link>
            <span>/</span>
            <Link href="/agency/profile?tab=orders" className="hover:text-green-600">My Orders</Link>
            <span>/</span>

      ...
      <div className="min-h-screen bg-white">
        <div className="mx-auto w-full max-w-7xl px-3 md:px-4 lg:px-6 py-4 sm:py-6 md:py-8 md:mt-20 pt-16">
          <div className="bg-white border border-gray-200 rounded-md p-12 text-center">
            ...
            <Link href="/agency/category" className="text-[#0a923c] hover:underline inline-flex items-center gap-2">
      ...
      <div className="mx-auto w-full max-w-7xl px-3 md:px-4 lg:px-6 py-4 sm:py-6 md:py-8 md:mt-20 pt-16">
        ...
        {category && (
          <div className="mb-4 flex items-center gap-2 text-sm text-gray-600">
            <Link href="/agency/category" className="hover:text-[#0a923c] transition-colors">
              Categories
            </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
          {/* SIDEBAR - Desktop - Enhanced AliExpress Style */}
                    ...
                    {categories
                      ...
                      .map((cat) => {
                        ...
                        return (
                          <Link
                            key={cat.id}
                            href={`/agency/category/${cat.slug}`}
                            className={`group relative px-4 py-3 mb-2 rounded-lg text-sm transition-all duration-300 ${
                              isActive
                                ? "bg-[#0a923c] text-white shadow-md"
                                : "text-gray-700 hover:bg-[#0a923c] hover:text-white hover:shadow-md"
                            }`}
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3 flex-1 min-w-0">
                                {cat.image ? (
                                  <div className={`relative w-10 h-10 rounded-md overflow-hidden shrink-0 border transition-colors shadow-sm ${
                                    isActive ? "border-white" : "border-gray-200 group-hover:border-white"
                                  }`}>
                                    <Image
                                      src={cat.image}
                                      alt={cat.name}
                                  ...
                                  <div className={`w-10 h-10 rounded-md flex items-center justify-center shrink-0 transition-colors shadow-sm ${
                                ...
                                <div className="flex-1 min-w-0">
                                  <span className={`font-semibold transition-colors block truncate ${
                              ...
                              <ChevronRightIcon className={`w-4 h-4 transition-all ml-2 shrink-0 ${
                                isActive 
                                  ? "text-white opacity-100" 
                                  : "text-gray-400 group-hover:text-white opacity-0 group-hover:opacity-100 group-hover:translate-x-1"
                              }`} />
                            </div>
                          </Link>
                        );
          ...
          <div className="flex-1">
            {/* Category Header */}
            {category && (
              <div className="bg-white border-b border-gray-200 mb-4 pb-4">
